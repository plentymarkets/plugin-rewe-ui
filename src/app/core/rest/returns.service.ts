...
@Injectable()
export class ReturnsService extends TerraBaseService {
    ...
    public listReturnReasons() {
        this.setAuthorization();
        this.setHeader();
        
        let url = this.url + 'return_reasons';
    ...
    public getSettings():Observable<any>
    {
        ...
        let url:string = this.url + 'return_reason_mappings';
